...
class PlansCheckoutPrivacy extends Component
{
    public function render()
    {
        ...
        return view('livewire.website.plans.plans-checkout.components.plans-checkout-privacy', compact('settings', 'generalPolicies', 'informationPolicies', 'legalPolicies', 'personalPolicies', 'cookiesPolicies', 'sharingPolicies', 'productPolicies', 'rightsPolicies', 'refundPolicies', 'profilePolicies', 'keepingPolicies', 'securityPolicies', 'deliveryPolicies'));
