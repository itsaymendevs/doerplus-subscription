...
class PlansCheckoutPrivacy extends Component
{
    public function render()
    {
        ...
        if (env('APP_CLIENT') == 'BeHealthy') {
            ...
            // 1: main
            $header = ['Be Healthy Terms and Conditions', "Welcome to Be Healthy! These Terms and Conditions outline the rules and regulations for the use of Be Healthy's website, products, and services. By accessing this website, we assume you accept these Terms and Conditions in full. Do not continue to use Be Healthy's website or services if you do not agree to all the Terms and Conditions stated on this page"];
            ...
            // 1: first
            $content[$counter++] = [
                "Welcome to Be Healthy! These Terms and Conditions outline the rules and regulations for the use of Be Healthy's website, products, and services",
                "By accessing this website, we assume you accept these Terms and Conditions in full. Do not continue to use Be Healthy's website or services if you do not agree to all the Terms and Conditions stated on this page"
            ];
