...
<html lang="en-US">
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{url('assets/plugins/subscription/css/login.css')}}" />
    ...
    {{-- body --}}
    <body class="home page d-flex align-items-center justify-content-center">
        <div class="container-page">
            ...
            {{-- preloader --}}
            <livewire:portals.customer.components.customer-preloader />
            ...
            {{-- cursor --}}
            <livewire:portals.customer.components.customer-cursor />
