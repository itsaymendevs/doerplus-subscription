<div class="wrapper">
    ...
    {{-- swiper --}}
    <div class="section half-slider" data-dispimgpath="{{ url('assets/plugins/subscription/images/clouds.jpg') }}">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <a href="javascript:void(0);" data-splitting
                                class="splitting-text-anim-1 plan--slide-button fw-semibold">View Plan</a>
                        </div>
