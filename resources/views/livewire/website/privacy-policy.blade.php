        ...
        <div class="container flex-column justify-content-end align-items-start">
            <div class="titles">
                <div class="title splitting-text-anim-1 scroll-animate  pb-4 plan--single-title" data-splitting="chars"
                    data-animate="active">Privacy Policy</div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
                    <div class="description-text scrolla-element-anim-1 scroll-animate" data-animate="active">
                        <p>Website is owned and managed by HealthyBite, a dedicated meal planners who simplify your life
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 ">
                    ...
                    <div class="description-text scrolla-element-anim-1 scroll-animate mb-5 d-none"
                        data-animate="active">
                        <p>There are a number of ways in which we use your personal information, depending on how you
                            interact with us. If you do not provide your information to us, then we will be unable to
                        ...
                        <div class="description-list-item scrolla-element-anim-1 scroll-animate policy--point"
                            ...
                            <div class="desc">
                                ...
                                <div class="name">This privacy policy was most recently updated in
                                    Augest 2024. If we make changes to it, then we will take appropriate steps to bring
